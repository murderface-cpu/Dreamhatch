...
const project = projects.find((p) => p.slug === "sustainability-climate-smart-farming")!;

export const Route = createFileRoute("/projects/sustainability-climate-smart-farming")({
  head: () => ({
    meta: [
